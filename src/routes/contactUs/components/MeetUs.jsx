...
const MeetUs = () => {
    ...
    return (
        <div className='meetUs-container'>
            ...
            <ul>
                <li className='phone contactList'><FaPhone size="3.5vh" className='icon'/> <a href="tel:+972526755240">0526755240</a></li>
                <li className='email contactList' ><FaMailBulk size="3.5vh" className='icon'/>  <a href="mailto:pelegshefi@hotmail.com">pelegshefi@hotamil.com</a></li>
